...
class Form_Objects_Add_Step1 extends Zend_Form {
	...
	public function __construct($options = null) {		
		...
		$o = new Zend_Form_Element_Text ( 'name');
		$o -> setLabel('Name:')
		->setRequired ( true )->addValidator ( 'NotEmpty' );
		
		// Aire de texte pour la définition de l'objet
		...
		$this->addElements ( array ($cp, $o, $definition, $submit ) );
	}
